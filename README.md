...
To run the formatters and linters automatically on commit, you can use [pre-commit](https://pre-commit.com/)
...
We use mockery to generate mocks under [internal/testing/mocks](internal/testing/mocks).
